 ...
 * @internal
 */
#[AsTaggedItem(index: ContextPathBuilderFormat::NUMBER_SIGN->value)]
final readonly class NumberSignContextPathBuilder extends AbstractContextPathBuilder implements ContextPathBuilderInterface
{
