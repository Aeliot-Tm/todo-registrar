...
Configuration file can either in YAML format ([see documentation about config YAML-file](general_config_yaml.md))
or PHP format ([see documentation about config PHP-file](general_config_php.md)). You can define custom path
