...
**NOTE:** You can pass a special value`--config=STDIN` then [script obtains YAML from STDIN](docs/config/global_config_yaml.md#loading-from-stdin).
...
First of all you have to create [general config](docs/config/global_config.md)
...
| Any custom Registrar | Read about [customization](docs/customization.md) |
