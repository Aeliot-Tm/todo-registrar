...
final class DetectorTest extends TestCase
{
    ...
    {
        yield [4, 'TODO: fix it'];
        yield [12, 'TODO APP-123: fix it'];
        yield [11, 'TODO@markus: fix it'];
        yield [19, 'TODO@markus APP-123: fix it'];
        yield [4, 'TODO- fix it'];
        yield [5, 'TODO - fix it'];
    }
    ...
    {
        yield [4, 'TODO text of comment'];
        yield [5, 'TODO: text of comment'];
        yield [16, 'TODO@an_assignee text of comment'];
        yield [17, 'TODO@an_assignee: text of comment'];
    }
