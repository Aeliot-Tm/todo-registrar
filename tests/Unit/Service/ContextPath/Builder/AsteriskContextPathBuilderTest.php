...
#[CoversClass(AsteriskContextPathBuilder::class)]
final class AsteriskContextPathBuilderTest extends TestCase
{
    ...
    {
        self::assertSame($expectedPath, (new AsteriskContextPathBuilder())->build($nodes));
    }
}
