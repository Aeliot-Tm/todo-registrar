...
#[CoversClass(NumberSignContextPathBuilder::class)]
final class NumberSignContextPathBuilderTest extends TestCase
{
    ...
    {
        self::assertSame($expectedPath, (new NumberSignContextPathBuilder())->build($nodes));
    }
}
